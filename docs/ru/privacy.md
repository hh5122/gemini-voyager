...
Voyager ("мы", "наш" или "нас") стремится защищать вашу конфиденциальность. Эта Политика конфиденциальности объясняет, как наше расширение Chrome собирает, использует и защищает вашу информацию.

## Сбор и использование данных

**Мы не собираем никакой личной информации.**

Voyager работает полностью в вашем браузере. Все данные, генерируемые или управляемые расширением (такие как папки, шаблоны промптов и настройки), хранятся:
