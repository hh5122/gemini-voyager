...
Última verificação: 15 de dezembro de 2024
...
- **Storage**: Para guardar as suas preferências, pastas e prompts.
- **ActiveTab**: Para interagir com a interface do Gemini quando utiliza a extensão.
