...
يلتزم Voyager ("نحن"، "نا"، أو "لنا") بحماية خصوصيتك. توضح سياسة الخصوصية هذه كيفية قيام إضافة Chrome الخاصة بنا بجمع معلوماتك واستخدامها وحمايتها.

## جمع البيانات واستخدامها

**نحن لا نجمع أي معلومات شخصية.**

يعمل Voyager بالكامل داخل متصفحك. يتم تخزين جميع البيانات التي تم إنشاؤها أو إدارتها بواسطة الامتداد (مثل المجلدات وقوالب المطالبات والإعدادات):
